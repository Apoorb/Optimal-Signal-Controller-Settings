...
da1[,EBT_Vol:=factor(EBT_Vol,levels = c("EBT = 800 veh/hr","EBT = 1600 veh/hr","EBT = 2400 veh/hr"))]
da1[,WBT_Vol:=factor(WBT_Vol,levels = c("WBT = 2400 veh/hr","WBT = 1600 veh/hr","WBT = 800 veh/hr"))]
...
SdaMax_ra[EBT_Vol==1200,EBT_Vol:="EBT = 2400 veh/hr"]
SdaMax_ra[WBT_Vol==400,WBT_Vol:="WBT = 800 veh/hr"]
SdaMax_ra[WBT_Vol==800,WBT_Vol:="WBT = 1600 veh/hr"]
SdaMax_ra[WBT_Vol==1200,WBT_Vol:="WBT = 2400 veh/hr"]
SdaMax_ra[,EBT_Vol:=factor(EBT_Vol,levels = c("EBT = 800 veh/hr","EBT = 1600 veh/hr","EBT = 2400 veh/hr"))]
SdaMax_ra[,WBT_Vol:=factor(WBT_Vol,levels = c("WBT = 2400 veh/hr","WBT = 1600 veh/hr","WBT = 800 veh/hr"))]
...
dilemma_dat_ra[EBT_Vol==1200,EBT_Vol:="EBT = 2400 veh/hr"]
dilemma_dat_ra[WBT_Vol==400,WBT_Vol:="WBT = 800 veh/hr"]
dilemma_dat_ra[WBT_Vol==800,WBT_Vol:="WBT = 1600 veh/hr"]
dilemma_dat_ra[WBT_Vol==1200,WBT_Vol:="WBT = 2400 veh/hr"]
dilemma_dat_ra[,EBT_Vol:=factor(EBT_Vol,levels = c("EBT = 800 veh/hr","EBT = 1600 veh/hr","EBT = 2400 veh/hr"))]
dilemma_dat_ra[,WBT_Vol:=factor(WBT_Vol,levels = c("WBT = 2400 veh/hr","WBT = 1600 veh/hr","WBT = 800 veh/hr"))]
...
setwd(tem)
jpeg("RAdarHgSpdDelay.jpeg",width=18,height=14,units = "cm",res=500)
a
graphics.off()
jpeg("RAdarSimulQueue.jpeg",width=18,height=14,units = "cm",res=500)
b
graphics.off()
jpeg("RAdarSimulEBMax.jpeg",width=16,height=14,units = "cm",res=500)
gmax1a+theme(legend.position="none")
graphics.off()
jpeg("RAdarSimulDilZn.jpeg",width=16,height=14,units = "cm",res=500)
Grdilemma+theme(legend.position="none")
graphics.off()

dil<-dilemma_dat_ra[Passage_time<0.6]
dil1<-dcast(dil,WBT_Vol+EBT_Vol~`Gap Out`,value.var = "AvgVehDilZnPerCyc")
dil1[,WBT_Vol:=ifelse(WBT_Vol=="WBT = 800 veh/hr",800,ifelse(WBT_Vol=="WBT = 1600 veh/hr",1600,2400))]
dil1[,EBT_Vol:=ifelse(EBT_Vol=="EBT = 800 veh/hr",800,ifelse(EBT_Vol=="EBT = 1600 veh/hr",1600,2400))]
dil1[,DecisionDif:=Simultaneous-`Non Simultaneous`]

MaxDat<-SdaMax_ra[Passage_time<0.6]
MaxDat1<-dcast(MaxDat,WBT_Vol+EBT_Vol~`Gap Out`,value.var = "Per_EBT_MaxOout")
MaxDat1[,WBT_Vol:=ifelse(WBT_Vol=="WBT = 800 veh/hr",800,ifelse(WBT_Vol=="WBT = 1600 veh/hr",1600,2400))]
MaxDat1[,EBT_Vol:=ifelse(EBT_Vol=="EBT = 800 veh/hr",800,ifelse(EBT_Vol=="EBT = 1600 veh/hr",1600,2400))]
MaxDat1[,MaxOutDif:=Simultaneous-`Non Simultaneous`]

fwrite(dil1,file.path(tem,"DecisionZn.csv"))
fwrite(MaxDat1,file.path(tem,"MaxOut.csv"))