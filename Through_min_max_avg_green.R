...
rm(list=ls())
dir1="C:/Users/a-bibeka/Dropbox/TTI_Projects/0-1-6934 TSC Settings Sunkari/Scenario_/Scenarios"
# dir1="C:/Users/a-bibeka/Dropbox/TTI_Projects/0-1-6934 TSC Settings Sunkari/Scenario_120cycle/Scenarios"
...
list_sen<-fread("List_Scenarios.csv")
...
SdaNew[,Volume:=ifelse(Actuated_St=="400","Low Volume","High Volume")]
...
sg_M1<-sg_M1+geom_bar(stat="identity",position =position_dodge())+facet_grid(Volume~`Passage time`,labeller=labeller(`Passage time`=gap_label))+ggtitle("EBT Green Time")+xlab("Detector Configuration")+ylab("EBT Green Time (seconds)")
...
# pdf("Induc_sigMinMax_120cycle.pdf")
pdf("Induc_sigMinMax_60cycle.pdf")
