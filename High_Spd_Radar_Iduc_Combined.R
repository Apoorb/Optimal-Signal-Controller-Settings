...
list_sen[Option=="All Detectors on Same Channel",`Det Type`:="Induction Loop -\nAll Detectors on\nSame Channel"]
list_sen[Option=="Stopbar Detector on Separate Channel",`Det Type`:="Induction Loop -\nStopbar Detector on\nSeparate Channel"]
...
dilemma_dat$VehNo=NULL
dilemma_dat$Run=NULL
...
Grdilemma<-det_plots_2(data1=dilemma_dat_comb,
                       ...
                       title1="Average Number of Vehicles Trapped\nin Decision Zone",vol_label=Vlab
)
...
pdf("/Users/Apoorb/Dropbox/TTI_Projects/0-1-6934 TSC Settings Sunkari/Det_R_code/results/HighSpd_Comb.pdf")
...
jpeg("RAdarHgSpdDelay.jpeg",width=14,height=12,units = "cm",res=500)
a
graphics.off()
jpeg("RAdarHgSpdQueue.jpeg",width=14,height=12,units = "cm",res=500)
b
graphics.off()
jpeg("RAdarHgSpdEBMax.jpeg",width=14,height=12,units = "cm",res=500)
gmax1a
graphics.off()
jpeg("RAdarHgSpdDilZn.jpeg",width=14,height=12,units = "cm",res=500)
Grdilemma
graphics.off()
jpeg("RAdarHgSpdEBRes.jpeg",width=14,height=12,units = "cm",res=500)
gResQ
graphics.off()
